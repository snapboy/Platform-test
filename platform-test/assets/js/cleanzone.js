		...
		init : function (c) {
			...
			function e(a, b) {
				if (($("#cl-wrapper").hasClass("sb-collapsed") || $(window).width() > 755 && $(window).width() < 963) && $("ul", a).length > 0) {
					...
					g.html('<ul class="sub-menu">' + c.html() + "</ul>"),
					g.show(),
					c.css("top", e)
				} else
					g.hide()
			...
			b.tooltip && $('.ttip, [data-toggle="tooltip"]').tooltip(),
			b.popover && $('[data-popover="popover"]').popover()
		}
	}
}
(), App = function () {
...
(App || {}), App = function () {
	return App.charts = function () {
		...
		if (jQuery.plot) { {
				var e = [],
				f = 250,
				g = [[1, c()], [2, c()], [3, 2 + c()], [4, 3 + c()], [5, 5 + c()], [6, 10 + c()], [7, 15 + c()], [8, 20 + c()], [9, 25 + c()], [10, 30 + c()], [11, 35 + c()], [12, 25 + c()], [13, 15 + c()], [14, 20 + c()], [15, 45 + c()], [16, 50 + c()], [17, 65 + c()], [18, 70 + c()], [19, 85 + c()], [20, 80 + c()], [21, 75 + c()], [22, 80 + c()], [23, 75 + c()]];
			...
			if (0 != $("#site_statistics").size()) {
				...
				var h = [[1, c()], [2, c()], [3, 2 + c()], [4, 3 + c()], [5, 5 + c()], [6, 10 + c()], [7, 15 + c()], [8, 20 + c()], [9, 25 + c()], [10, 30 + c()], [11, 35 + c()], [12, 25 + c()], [13, 15 + c()], [14, 20 + c()], [15, 45 + c()], [16, 50 + c()], [17, 65 + c()], [18, 70 + c()], [19, 85 + c()], [20, 80 + c()], [21, 75 + c()], [22, 80 + c()], [23, 75 + c()]],
				i = [[1, c()], [2, c()], [3, 10 + c()], [4, 15 + c()], [5, 20 + c()], [6, 25 + c()], [7, 30 + c()], [8, 35 + c()], [9, 40 + c()], [10, 45 + c()], [11, 50 + c()], [12, 55 + c()], [13, 60 + c()], [14, 70 + c()], [15, 75 + c()], [16, 80 + c()], [17, 85 + c()], [18, 90 + c()], [19, 95 + c()], [20, 100 + c()], [21, 110 + c()], [22, 120 + c()], [23, 130 + c()]],
				e = ($.plot($("#chart3"), [{
								data : i,
								showLabels : !0,
								label : "New Visitors",
...
(App || {}), App = function () {
	return App.dashboard = function (a) {
		...
		if (f.add($("#sun-icon")[0], Skycons.PARTLY_CLOUDY_DAY), f.play(), $(".spk1").sparkline([2, 4, 3, 6, 7, 5, 8, 9, 4, 2, 6, 8, 8, 9, 10], {
			...
			var g = [],
			h = [[1, c()], [2, c()], [3, 2 + c()], [4, 3 + c()], [5, 5 + c()], [6, 10 + c()], [7, 15 + c()], [8, 20 + c()], [9, 25 + c()], [10, 30 + c()], [11, 35 + c()], [12, 25 + c()], [13, 15 + c()], [14, 20 + c()], [15, 45 + c()], [16, 50 + c()], [17, 65 + c()], [18, 70 + c()], [19, 85 + c()], [20, 80 + c()], [21, 75 + c()], [22, 80 + c()], [23, 75 + c()]],
			i = [[1, c() - 5], [2, c() - 5], [3, c() - 5], [4, 6 + c()], [5, 5 + c()], [6, 20 + c()], [7, 25 + c()], [8, 36 + c()], [9, 26 + c()], [10, 38 + c()], [11, 39 + c()], [12, 50 + c()], [13, 51 + c()], [14, 12 + c()], [15, 13 + c()], [16, 14 + c()], [17, 15 + c()], [18, 15 + c()], [19, 16 + c()], [20, 17 + c()], [21, 18 + c()], [22, 19 + c()], [23, 20 + c()], [24, 21 + c()], [25, 14 + c()], [26, 24 + c()], [27, 25 + c()], [28, 26 + c()], [29, 27 + c()], [30, 31 + c()]];
			if (0 != $("#site_statistics").size()) {
				$("#site_statistics_loading").hide(),
				$("#site_statistics_content").show();
				...
				var j = [[1, c() - 5], [2, c() - 5], [3, c() - 5], [4, 6 + c()], [5, 6 + c()], [6, 6 + c()], [7, 5 + c()], [8, 3 + c()], [9, 2 + c()]],
				k = ($.plot($("#com_stats"), [{
								data : j,
								showLabels : !0,
								labels : j,
					...
					}), [[1, c()], [2, c()], [3, 2 + c()], [4, 3 + c()], [5, 5 + c()], [6, 10 + c()], [7, 15 + c()], [8, 20 + c()], [9, 20 + c()], [10, 20 + c()], [11, 20 + c()], [12, 20 + c()], [13, 20 + c()], [14, 20 + c()], [15, 20 + c()], [16, 75 + c()]]),
				l = ($.plot($("#com2_stats"), [{
								data : k,
								label : "Unique Visits"
							}
			...
			$(".chat-in form").submit(function (a) {
				...
				$(this).parents(".chat-wi").find(".chat-content").append(g),
				g.slideDown(),
				a.preventDefault()
			}),
			d.introTour && introJs().setOption("showBullets", !1).start(),
...
(App || {}), App = function () {
	return App.dataTables = function () {
		...
		function a(a, b) {
			...
			return d += "<tr><td>Rendering engine:</td><td>" + c[1] + " " + c[4] + "</td></tr>",
			d += "<tr><td>Link to source:</td><td>Could provide a link here</td></tr>",
			d += "<tr><td>Extra info:</td><td>And any further details here (images etc)</td></tr>",
			d += "</table>"
		}
		$("#datatable").dataTable(),
		...
		d.innerHTML = '<img class="toggle-details" src="' + App.conf.assetsPath + "/" + App.conf.imgPath + '/plus.png" />',
		d.className = "center",
	...
	return App.formElements = function () {
		...
		$("#reservationtime").daterangepicker({
			...
			var a = function (a, b) {
				...
				alert("Callback has fired: [" + a.format("MMMM D, YYYY") + " to " + b.format("MMMM D, YYYY") + "]")
			},
			b = {
...
(App || {}), App = function () {
	return App.multiSelect = function () {
		...
		for (var a = 1; 100 >= a; a++)
			$("#example11").append('<option value="' + a + '">Options ' + a + "</option>");
		...
		for (var a = 1; 100 >= a; a++)
			$("#example28").append('<option value="' + a + '">' + a + "</option>");
...
(App || {}), App = function () {
	return App.pageProfile = function () {
		...
		b,
		c,
		d = App.conf.assetsPath + "/" + App.conf.libsPath + "/jquery.upload/server/php/index.php";
		$("#fileupload").fileupload({
			...
			dataType : "json",
				...
				$.each(e.result.files, function (d, e) {
					b = e.name,
					c = e.url,
					$(".crop-image").html('<img src="' + App.conf.assetsPath + "/" + App.conf.libsPath + "/jquery.upload/server/php/files/" + e.name + '" />'),
					$("#progress").fadeOut(),
...
(App || {}), App = function () {
	return App.pageSearch = function () {
		...
		$("#price-range").slider().on("slide", function (a) {
			$("#price1").html("$" + a.value[0]),
			$("#price2").html("$" + a.value[1])
		})
	},
	App
}
...
(App || {}), App = function () {
	return App.treeView = function () {
		...
		$("label.tree-toggler").click(function () {
			...
			a.hasClass("fa-folder-o") ? a.removeClass("fa-folder-o").addClass("fa-folder-open-o") : a.removeClass("fa-folder-open-o").addClass("fa-folder-o"),
	...
	if ("webkitSpeechRecognition" in window) {
		...
		var b = {
			...
			listen : function (a) {
				...
				$(".side-user .info a").html(c),
				$(".profile_menu > a span").html(c)
			}
		};
		App.speechCommand("hello", b),
		App.speechCommand("hi", b);
		var c = {
			action : function () {
				$.gritter.add({
					title : "Clean Zone",
		...
		App.speechCommand("thanks", c),
		App.speechCommand("thank you", c),
		App.speechCommand("email", {
			...
			dictationEnd : function () {
				...
				a.appendTo("#mod-info .modal-body").fadeIn(),
...
var App = function () {
	return App.speech_commands = [],
	"webkitSpeechRecognition" in window && (App.rec = new webkitSpeechRecognition),
	App.speech = function (a) {
		"use strict";
		if ("webkitSpeechRecognition" in window)
			if ("start" == a)
				App.rec.start();
				...
				$.extend(b, a),
				b.continuous && (App.rec.continuous = !0),
				b.interim && (App.rec.interimResults = !0),
				b.lang && (App.rec.lang = b.lang);
				var c = !1,
				d = "";
	...
	App.speechCommand = function (a, b) {
		...
		$.extend(c, b),
		a ? c.action ? App.speech_commands.push({
			command : a,
...
$(function () {
	...
	if ("webkitSpeechRecognition" in window) {
		...
		App.speechCommand("go to", {
			action : function () {
				$.gritter.add({
					title : "Go to Page",
					text : "Tell me where do you want to go?",
					image : App.conf.assetsPath + "/" + App.conf.imgPath + "/mic-icon.png",
					class_name : "clean",
					time : ""
				})
			},
		...
		"on" == a("listen") && App.speech("start"),
		$(".speech-button").click(function (a) {
			var b = $('<div role="dialog" tabindex="-1" id="mod-sound" data-backdrop="false" class="modal fade"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button><h2 class="hthin"><img src="' + App.conf.assetsPath + "/" + App.conf.imgPath + '/mic-icon.png" /> Speech API</h2></div><div class="modal-body" style="padding:0 25px;"><div><h4>Voice Recognition</h4><div><p class="text-left">Thanks to Google Speech API we can do <a href="https://dvcs.w3.org/hg/speech-api/raw-file/tip/speechapi.html">Speech Recognition</a> in our web sites, initially Chrome 25+ and up versions support this, but don&#39;t worry! browsers are working on a <a href="https://wiki.mozilla.org/HTML5_Speech_API">standard</a> and soon we will see this working on our favorites browsers. </p><h4 class="spacer2">Let the party begin</h4><p>First you must to allow microphone access clicking on <strong>"Allow"</strong> option above this modal. After this you&#39;ll see the Microphone icon with a blur effect, this means that voice recognition starts.</p><h4 class="spacer2">Voice Commands</h4><p>After that, try to say <strong>"Hello"</strong> at your mic. Do you see what happens? things in template start to change, now try these commands:</p><ul><li><strong>"Go to"</strong>: wait for a message and then say a page title like "tables"</li><li><strong>"Change title"</strong> - Sets template title</li><li><strong>"Scroll down"</strong> and <strong>"Scroll up"</strong></li><li><strong>"Go top"</strong> and <strong>"Go bottom"</strong></li><li><strong>"Toggle sidebar"</strong></li><li><strong>"log out"</strong></li><li><strong>"Thank you"</strong></li><li><strong>"Stop"</strong> - Stops recognition</li><li><strong>"Email"</strong> - Compose an e-mail with your voice, to end dictation just say "end of email"</li></ul><p>Do you want more commands? you can add a voice command easily with our own API.</p></div></div></div><div class="modal-footer"><button data-dismiss="modal" class="btn btn-primary" type="button">DONE!</button></div></div></div></div>');
			b.appendTo("body"),
			$("#mod-sound").modal(),
			$("#mod-sound").on("hidden.bs.modal", function () {
				$(this).removeData("bs.modal"),
